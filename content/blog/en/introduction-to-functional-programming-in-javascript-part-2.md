...
In [part 1](introduction-to-functional-programming-in-javascript-part-1.md), we had learned about two important concepts in functional programming paradigm: immutable data and pure function. Now, we will learn another important concept in functional programming, that is higher order function.

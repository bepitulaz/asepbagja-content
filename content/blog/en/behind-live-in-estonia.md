...
Uploading it to the Internet is the definite answer. The easy solution is to upload it to Instagram. Of course, I did that. But, I'm not a person who trusts 3rd party social media platforms to upload all my works. I started prioritising my domain as [my house of content in 2019](going-back-to-personal-web.md) rather than posting it on social media platforms. Furthermore, I like the [IndieWeb](https://indieweb.org) concept, "your content is yours, and you are in control."

Because of that reason, I casually searched for a .com domain name related to Estonia in [Namecheap](https://namecheap.pxf.io/x9Pgmx) a few weeks ago. I need a domain to be a place for all photos that I take almost every week. Lucky, I found an available good domain name [liveinestonia.com](https://www.liveinestonia.com).
